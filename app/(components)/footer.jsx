      ...
      <div className={cn("newsletter_footer", className)}>
        ...
        >
          <div className="container mx-auto flex flex-col items-center">
            <div className="subtitle text-[#20B15A] text-xl not-italic font-medium leading-[normal] uppercase">
              SUBSCRIBE
            </div>
            <div className="title text-black text-center text-3xl not-italic font-semibold leading-[normal] capitalize pt-[22px] pb-[5px]">
            ...
            {/* w-[596px] */}
            <form className="newsletter_form mt-[40px] h-[62px] pl-[15px] pr-[6px] border rounded-[14px] border-solid border-black  flex items-center">
              <input
                type="email"
              ...
              <input
                type="submit"
                className="rounded-[14px] bg-[#f55f1d] flex h-[52.703px] justify-center items-center gap-[8.108px] px-[24.325px] py-[8.108px] text-white text-[16.216px] not-italic font-medium leading-[normal]"
                value="Subscribe"
              />
            </form>
          </div>
        ...
        {/* <footer
          id="footer"
          className={cn("footer bg-black pt-[80px] pb-[29px]")}
        >
          <div className="footer_top container mx-auto grid grid-cols-12">
            <div className="col-span-4">
              <h1 className="text-white text-[39.2px] not-italic font-bold leading-[normal]">
                LOGO HERE
              </h1>
